...
u64 object_link_boy_TLUT_000000[] = {
#include "assets/objects/object_link_boy/tlut_000000.rgba16.inc.c"
};

u64 object_link_boy_TLUT_000200[] = {
#include "assets/objects/object_link_boy/tlut_000200.rgba16.inc.c"
};

u64 gLinkFierceDeityHandHoldingTLUT[] = {
#include "assets/objects/object_link_boy/hand_holding_tlut.rgba16.inc.c"
};

u64 object_link_boy_Tex_000600[] = {
#include "assets/objects/object_link_boy/tex_000600.ci8.inc.c"
};

u64 object_link_boy_Tex_000800[] = {
#include "assets/objects/object_link_boy/tex_000800.ci8.inc.c"
};

u64 gLinkFierceDeityHandHoldingTex[] = {
#include "assets/objects/object_link_boy/hand_holding.ci8.inc.c"
};

u64 object_link_boy_Tex_000B00[] = {
#include "assets/objects/object_link_boy/tex_000B00.i8.inc.c"
};

Vtx object_link_boyVtx_000C00[] = {
#include "assets/objects/object_link_boy/object_link_boyVtx_000C00.vtx.inc"
};
...
Gfx gLinkFierceDeityWaistDL[] = {
    ...
    gsDPLoadTextureBlock_4b(object_link_boy_Tex_008408, G_IM_FMT_CI, 16, 16, 15, G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR |
                            G_TX_WRAP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x02FC, 0x003C),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[302], 9, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(0, 3, 4, 0, 5, 6, 7, 0),
    gsSP1Triangle(5, 7, 8, 0),
    gsSPVertex(&object_link_boyVtx_000C00[311], 4, 0),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[315], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(0, 3, 4, 0, 0, 4, 5, 0),
    gsDPPipeSync(),
    gsDPLoadTLUT_pal16(15, object_link_boy_TLUT_008148),
    gsDPLoadTextureBlock_4b(object_link_boy_Tex_008D08, G_IM_FMT_CI, 32, 32, 15, G_TX_NOMIRROR | G_TX_CLAMP,
                            G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[321], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTLUT_pal16(15, object_link_boy_TLUT_008168),
    gsDPLoadTextureBlock_4b(object_link_boy_Tex_008F08, G_IM_FMT_CI, 64, 64, 15, G_TX_NOMIRROR | G_TX_CLAMP,
                            G_TX_NOMIRROR | G_TX_CLAMP, 6, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[325], 16, 0),
    ...
    gsSPVertex(&object_link_boyVtx_000C00[341], 12, 0),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx gLinkFierceDeityRightShinDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[41], 1, 0),
    gsSPVertex(&object_link_boyVtx_000C00[42], 1, 1),
    gsSPVertex(&object_link_boyVtx_000C00[43], 3, 2),
    ...
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x003C),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_link_boyVtx_000C00[46], 15, 5),
    ...
    gsSPVertex(&object_link_boyVtx_000C00[61], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 1, 3, 0),
    gsSP2Triangles(2, 3, 4, 0, 4, 3, 5, 0),
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(object_link_boy_Tex_008488, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 32, 0, G_TX_MIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 4, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C),
    gsSPVertex(&object_link_boyVtx_000C00[67], 18, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsDPPipeSync(),
    gsDPLoadTextureBlock(object_link_boy_Tex_008888, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_link_boyVtx_000C00[85], 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx gLinkFierceDeityRightFootDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(object_link_boyVtx_000C00, 4, 0),
    ...
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(object_link_boy_Tex_008208, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_link_boyVtx_000C00[4], 22, 4),
    ...
    gsSPVertex(&object_link_boyVtx_000C00[26], 15, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx gLinkFierceDeityLeftShinDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[191], 2, 0),
    gsSPVertex(&object_link_boyVtx_000C00[193], 2, 2),
    gsSPVertex(&object_link_boyVtx_000C00[195], 1, 4),
    ...
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x003C),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_link_boyVtx_000C00[196], 15, 5),
    ...
    gsSP2Triangles(16, 0, 17, 0, 18, 2, 19, 0),
    gsSPVertex(&object_link_boyVtx_000C00[211], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 1, 0),
    gsSP2Triangles(3, 1, 0, 0, 5, 4, 3, 0),
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(object_link_boy_Tex_008488, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 4, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C),
    gsSPVertex(&object_link_boyVtx_000C00[217], 19, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    ...
    gsDPLoadTextureBlock(object_link_boy_Tex_008888, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_link_boyVtx_000C00[236], 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx gLinkFierceDeityLeftFootDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[150], 4, 0),
    ...
    gsDPLoadTextureBlock(object_link_boy_Tex_008208, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_link_boyVtx_000C00[154], 22, 4),
    ...
    gsSPVertex(&object_link_boyVtx_000C00[176], 15, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 7, 0, 3, 0),
    gsSP2Triangles(7, 3, 8, 0, 8, 9, 10, 0),
...
Gfx object_link_boy_DL_0060E8[] = {
    ...
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[765], 24, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(6, 7, 8, 0, 9, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 15, 16, 17, 0),
...
Gfx gLinkFierceDeityTorsoDL[] = {
    ...
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal16(15, object_link_boy_TLUT_0081E8),
    gsDPLoadTextureBlock_4b(object_link_boy_Tex_00B188, G_IM_FMT_CI, 64, 64, 15, G_TX_NOMIRROR | G_TX_CLAMP,
                            G_TX_NOMIRROR | G_TX_CLAMP, 6, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[935], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 0, 0),
    ...
    gsDPLoadTextureBlock_4b(object_link_boy_Tex_008F08, G_IM_FMT_CI, 64, 64, 15, G_TX_NOMIRROR | G_TX_CLAMP,
                            G_TX_NOMIRROR | G_TX_CLAMP, 6, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_link_boyVtx_000C00[967], 17, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx object_link_boy_DL_006370[] = {
    ...
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[984], 6, 0),
...
Gfx gLinkFierceDeityRightForearmDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[846], 7, 0),
    ...
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x003C),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_link_boyVtx_000C00[853], 11, 7),
    gsSP2Triangles(7, 4, 5, 0, 8, 5, 9, 0),
    gsSP2Triangles(0, 10, 11, 0, 0, 12, 13, 0),
    gsSP2Triangles(14, 15, 3, 0, 3, 4, 16, 0),
    gsSP1Triangle(17, 5, 0, 0),
    gsSPVertex(&object_link_boyVtx_000C00[864], 6, 7),
    gsSP2Triangles(1, 6, 7, 0, 8, 6, 2, 0),
    gsSP2Triangles(2, 9, 10, 0, 11, 12, 1, 0),
    gsSPVertex(&object_link_boyVtx_000C00[870], 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP1Triangle(3, 2, 4, 0),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPLoadTLUT_pal16(15, object_link_boy_TLUT_0081A8),
    gsDPLoadTextureBlock_4b(object_link_boy_Tex_00AF08, G_IM_FMT_CI, 32, 32, 15, G_TX_MIRROR | G_TX_WRAP, G_TX_NOMIRROR
                            | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x01FC, 0x007C),
    gsSPVertex(&object_link_boyVtx_000C00[875], 18, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx gLinkFierceDeityRightHandDL[] = {
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal16(15, object_link_boy_TLUT_0081A8),
    gsDPLoadTextureBlock_4b(object_link_boy_Tex_00AF08, G_IM_FMT_CI, 32, 32, 15, G_TX_NOMIRROR | G_TX_CLAMP,
                            G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[789], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 0, 3, 0, 4, 3, 5, 0),
    gsSPVertex(&object_link_boyVtx_000C00[795], 7, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(5, 6, 3, 0, 2, 6, 0, 0),
    gsSP1Triangle(2, 3, 6, 0),
    gsSPVertex(&object_link_boyVtx_000C00[802], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 0, 2, 0),
    gsSP2Triangles(4, 0, 3, 0, 4, 3, 5, 0),
    gsSPVertex(&object_link_boyVtx_000C00[808], 11, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsDPLoadTextureBlock_4b(gLinkFierceDeityHandTex, G_IM_FMT_CI, 16, 16, 15, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR
                            | G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_link_boyVtx_000C00[819], 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&object_link_boyVtx_000C00[831], 11, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsDPLoadTextureBlock_4b(object_link_boy_Tex_00AF08, G_IM_FMT_CI, 32, 32, 15, G_TX_NOMIRROR | G_TX_CLAMP,
                            G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_link_boyVtx_000C00[842], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Gfx gLinkFierceDeityLeftForearmDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[672], 1, 0),
    gsSPVertex(&object_link_boyVtx_000C00[673], 6, 1),
    ...
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x003C),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_link_boyVtx_000C00[679], 6, 7),
    gsSP2Triangles(3, 0, 7, 0, 8, 0, 2, 0),
    gsSP2Triangles(9, 10, 3, 0, 2, 11, 12, 0),
    gsSPVertex(&object_link_boyVtx_000C00[685], 11, 7),
    ...
    gsDPLoadTextureBlock_4b(object_link_boy_Tex_00AF08, G_IM_FMT_CI, 32, 32, 15, G_TX_MIRROR | G_TX_WRAP, G_TX_NOMIRROR
                            | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x01FC, 0x007C),
    gsSPVertex(&object_link_boyVtx_000C00[696], 18, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    ...
    gsDPLoadTextureBlock_4b(object_link_boy_Tex_008408, G_IM_FMT_CI, 16, 16, 15, G_TX_MIRROR | G_TX_CLAMP, G_TX_NOMIRROR
                            | G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x003C),
    gsSPVertex(&object_link_boyVtx_000C00[714], 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP1Triangle(3, 2, 4, 0),
    gsSPEndDisplayList(),
};
...
Gfx gLinkFierceDeityLeftHandDL[] = {
    ...
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_000C00[615], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 0, 3, 0, 4, 3, 5, 0),
    gsSPVertex(&object_link_boyVtx_000C00[621], 7, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(5, 6, 3, 0, 2, 6, 0, 0),
    gsSP1Triangle(6, 5, 0, 0),
    gsSPVertex(&object_link_boyVtx_000C00[628], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(3, 2, 4, 0, 5, 3, 4, 0),
    gsSPVertex(&object_link_boyVtx_000C00[634], 11, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsDPLoadTextureBlock_4b(gLinkFierceDeityHandTex, G_IM_FMT_CI, 16, 16, 15, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR
                            | G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_link_boyVtx_000C00[645], 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&object_link_boyVtx_000C00[657], 11, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(object_link_boy_Tex_00B988, G_IM_FMT_RGBA, G_IM_SIZ_16b, 50, 75, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 6, 7, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_link_boyVtx_000C00[668], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx object_link_boyVtx_007110[] = {
#include "assets/objects/object_link_boy/object_link_boyVtx_007110.vtx.inc"
};
...
Gfx gLinkFierceDeityLeftHandHoldBottleDL[] = {
    ...
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(object_link_boyVtx_007110, 22, 0),
    ...
    gsDPPipeSync(),
    gsDPLoadTLUT_pal256(object_link_boy_TLUT_000200),
    gsDPLoadTextureBlock(object_link_boy_Tex_000800, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 32, 0, G_TX_MIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 4, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_link_boyVtx_007110[22], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 1, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTLUT_pal256(object_link_boy_TLUT_000000),
    gsDPLoadTextureBlock(object_link_boy_Tex_000600, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 32, 0, G_TX_MIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 4, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_link_boyVtx_007110[26], 15, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx object_link_boy_DL_007A50[] = {
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_007110[41], 10, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx gLinkFierceDeityBottleDL[] = {
    ...
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL0, PRIMITIVE, PRIM_LOD_FRAC, SHADE, TEXEL0, 0, PRIMITIVE, 0, PRIMITIVE, ENVIRONMENT,
                       COMBINED, ENVIRONMENT, 0, 0, 0, COMBINED),
    gsDPSetPrimColor(0, 0xFF, 255, 255, 255, 255),
    gsDPSetEnvColor(100, 140, 150, 255),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_XLU_SURF2),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock_4b(gBottleTex, G_IM_FMT_I, 16, 16, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 4,
                            4, 2, 2),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_007110[51], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 11, 9, 8, 0),
    gsSP2Triangles(9, 12, 0, 0, 0, 12, 13, 0),
    ...
    gsSPVertex(&object_link_boyVtx_007110[81], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
...
Gfx gLinkFierceDeitySwordDL[] = {
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(object_link_boy_Tex_000B00, G_IM_FMT_I, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_WRAP,
...
u64 object_link_boy_TLUT_008108[] = {
#include "assets/objects/object_link_boy/tlut_008108.rgba16.inc.c"
};

u64 object_link_boy_TLUT_008128[] = {
#include "assets/objects/object_link_boy/tlut_008128.rgba16.inc.c"
};

u64 object_link_boy_TLUT_008148[] = {
#include "assets/objects/object_link_boy/tlut_008148.rgba16.inc.c"
};

u64 object_link_boy_TLUT_008168[] = {
#include "assets/objects/object_link_boy/tlut_008168.rgba16.inc.c"
};

u64 object_link_boy_TLUT_008188[] = {
#include "assets/objects/object_link_boy/tlut_008188.rgba16.inc.c"
};

u64 object_link_boy_TLUT_0081A8[] = {
#include "assets/objects/object_link_boy/tlut_0081A8.rgba16.inc.c"
};

u64 gLinkFierceDeityHandTLUT[] = {
#include "assets/objects/object_link_boy/hand_tlut.rgba16.inc.c"
};

u64 object_link_boy_TLUT_0081E8[] = {
#include "assets/objects/object_link_boy/tlut_0081E8.rgba16.inc.c"
};

u64 object_link_boy_Tex_008208[] = {
#include "assets/objects/object_link_boy/tex_008208.rgba16.inc.c"
};

u64 object_link_boy_Tex_008408[] = {
#include "assets/objects/object_link_boy/tex_008408.ci4.inc.c"
};

u64 object_link_boy_Tex_008488[] = {
#include "assets/objects/object_link_boy/tex_008488.rgba16.inc.c"
};

u64 object_link_boy_Tex_008888[] = {
#include "assets/objects/object_link_boy/tex_008888.rgba16.inc.c"
};

u64 object_link_boy_Tex_008C88[] = {
#include "assets/objects/object_link_boy/tex_008C88.ci4.inc.c"
};

u64 object_link_boy_Tex_008D08[] = {
#include "assets/objects/object_link_boy/tex_008D08.ci4.inc.c"
};

u64 object_link_boy_Tex_008F08[] = {
#include "assets/objects/object_link_boy/tex_008F08.ci4.inc.c"
};

u64 gLinkFierceDeityEyesTex[] = {
#include "assets/objects/object_link_boy/eyes.rgba16.inc.c"
};

u64 object_link_boy_Tex_00A708[] = {
#include "assets/objects/object_link_boy/tex_00A708.ci4.inc.c"
};

u64 gLinkFierceDeityMouthTex[] = {
#include "assets/objects/object_link_boy/mouth.rgba16.inc.c"
};

u64 gLinkFierceDeityEarTex[] = {
#include "assets/objects/object_link_boy/ear.rgba16.inc.c"
};

u64 object_link_boy_Tex_00AF08[] = {
#include "assets/objects/object_link_boy/tex_00AF08.ci4.inc.c"
};

u64 gLinkFierceDeityHandTex[] = {
#include "assets/objects/object_link_boy/hand.ci4.inc.c"
};

u64 object_link_boy_Tex_00B188[] = {
#include "assets/objects/object_link_boy/tex_00B188.ci4.inc.c"
};

u64 object_link_boy_Tex_00B988[] = {
#include "assets/objects/object_link_boy/tex_00B988.rgba16.inc.c"
};

u8 object_link_boy_unaccounted_00D670[] = {
